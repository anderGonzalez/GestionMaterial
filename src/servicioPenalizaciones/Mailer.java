...
public class Mailer {
	...
	static {
		...
		try {
			login.load(new FileInputStream("mailConf.txt"));
	...
	public static void Send(String recipientEmail, String title, String message)
		...
		Mailer.Send(recipientEmail, "", title, message);
	}
	...
	public static void Send(String recipientEmail, String ccEmail, String title, String message)
		...
		msg.setFrom(new InternetAddress(login.getProperty("user") + "@gmail.com"));
		...
		t.connect("smtp.gmail.com", login.getProperty("user"), login.getProperty("password"));
